...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        cal_1 = self.get_mean_speed()**self.cf_cal_walk_2 // self.height
        cal_2 = self.cf_cal_walk_1 * self.weight
        cal_3 = self.cf_cal_walk_3 * self.weight
        calories = (cal_1 * cal_3 + cal_2) * self.duration * 60
        return calories
